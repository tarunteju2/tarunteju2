...
```diff
+ Normalised data model for analytics
...
```diff
+ Python · NLP · AWS Lambda · DynamoDB
+ Glue ETL: unstructured PDF → tables
- 30% doc processing time
+ 25% classification accuracy lift
...
```diff
+ TensorFlow + YOLO object detection
+ Modular robotics architecture
+ IoT sensor telemetry loop
